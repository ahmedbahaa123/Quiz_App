...
import com.bahaa.quizapp.QuizListModel;
...
public class DetailsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        quizListViewModel.getQuizMutableLiveData().observe(getViewLifecycleOwner(), new Observer<List<QuizListModel>>() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.details_start_btn:
                ...
                action.setTotalQuestion(totalQuestions);
